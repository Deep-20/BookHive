...
// BookForm component - A modal form for adding/updating book details
const BookForm = ({
                    isUpdateForm,    // Boolean to determine if form is for updating existing book
                    isModalOpen,     // Controls modal visibility
                    handleCloseModal,// Function to close the modal
                    book,           // Book object containing form data
                    setBook,        // Function to update book state
                    handleAddBook,   // Function to handle book creation
                    handleUpdateBook // Function to handle book updates
                  }) => {

  // State for loading indicator and form options
  ...
  // Load authors and genres when component mounts
  useEffect(() => {
    getAllAuthors();
    getAllGenres();
  }, []);
