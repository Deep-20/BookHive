...
// Base color for general shadows using grey from the palette
const color = palette.grey[500];

export default function customShadows() {
  // Create semi-transparent version of the base color for shadows
  const transparent = alpha(color, 0.16);

  return {
    // Elevation shadows with increasing intensity (z-axis height)
    ...
    // Themed shadows for different states/components using palette colors
    ...
    // Special component-specific shadows with multiple layers
